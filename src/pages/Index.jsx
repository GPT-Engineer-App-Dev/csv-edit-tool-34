      ...
      <VStack spacing={4} width="100%">
        ...
        <CSVReader onUploadAccepted={(results) => handleUpload(results)}>
          {({ getRootProps, acceptedFile }) => (
            <>
              <Button {...getRootProps()} colorScheme="teal">Upload CSV</Button>
        ...
        {data.length > 0 && (
          <>
            ...
            <Button leftIcon={<FaPlus />} colorScheme="green" onClick={handleAddRow}>Add Row</Button>
            <Button leftIcon={<FaDownload />} colorScheme="blue" onClick={handleDownload}>Download CSV</Button>
          </>
        )}
      </VStack>
    </Container>
